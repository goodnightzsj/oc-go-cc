...
- **修正上文（已清理 2026-08-27）**：8-26 的双写残留合计 $0.00375276 已从远端删除（备份 `backup-20260827-cleanup.db`），删除的是回填脚本复制的多余行 `req-1787738673-17` / `req-1787738699-20` / `req-1787754050-471`，保留逐 token 与平台 usg 全等的真身（`req-19`↔usg_01M0YRFBHS、`req-21`↔usg_01M0YRFFD、`req-470`↔usg_01M0Z73TDS，第三组另有 CompactGate 单条 out=128 记录佐证）。清理后 **8-26 远端 1501 行 $4.9939 = 平台 1501 行 $4.9939，完全一致**。
